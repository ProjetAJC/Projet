...
DATA DIVISION.
    ...
    SCREEN SECTION.
    01  STDSCREEN BLANK SCREEN BACKGROUND-COLOR 0 FOREGROUND-COLOR 2.
...
PRINCIPAL SECTION.
	...
	PERFORM UNTIL WS_CONTINUE = 0
		...
		EVALUATE WS_CHOICE
			...
			WHEN "1" CALL "F1" USING WS_CONTINUE
			WHEN "2" CALL "F2" USING WS_CONTINUE
			WHEN "3" CALL "F3" USING WS_CONTINUE
			WHEN "4" CALL "F4" USING WS_CONTINUE
			WHEN "5" CALL "F5" USING WS_CONTINUE
			WHEN "6" CALL "F6" USING WS_CONTINUE
			WHEN "7" CALL "F7" USING WS_CONTINUE
