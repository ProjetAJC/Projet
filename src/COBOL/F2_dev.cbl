...
SQL_QUERY_F2.
    EXEC SQL
        ...
        INNER JOIN PILOTES
            ON  VOLS.ID_PILOTE = PILOTES.ID_PILOTE
        INNER JOIN ETAT_PILOTE
            ON  PILOTES.ID_ETATP = ETAT_PILOTE.ID_ETATP
...
SQL_UPDATE_F2.
    ...
    END-EXEC.
    IF SQL_CODE = 0 THEN
        MOVE "Mise-a-jour de la base de donnees realisee avec succes." TO WS_MSG
    ELSE
        MOVE "Erreur lors de la mise-a-jour de la base de donnees." TO WS_MSG
    END-IF.
    PERFORM INIT_VALUES_F2.
    DISPLAY CLRSCREEN.
    DISPLAY STDSCREEN.
