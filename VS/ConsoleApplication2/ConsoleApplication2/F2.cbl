       ...
       DATA DIVISION.
           ...
           01  VALSCREEN BACKGROUND-COLOR 0 FOREGROUND-COLOR 2.
               05  VALHEADER BACKGROUND-COLOR 0 FOREGROUND-COLOR 2.
                   10  LINE 3  COL 2 PIC 9(2) FROM WS_CURR_DAY.
                   10  LINE 3  COL 4 VALUE "/".
                   10  LINE 3  COL 5 PIC 9(2) FROM WS_CURR_MONTH.
                   10  LINE 3  COL 7 VALUE "/".
                   ...
                   10  LINE 3  COL 62 PIC X(25) FROM WS_FUNC.
                   10  LINE 6  COL 1 PIC X(80) FROM WS_LINE.
               05  VALBODY BACKGROUND-COLOR 0 FOREGROUND-COLOR 7.
                   10  LINE 8  COL 2 PIC X(80) FROM WS_RECAP.
                   10  LINE 10 COL 2 PIC X(80) FROM WS_NVOL.
                   10  LINE 11 COL 2 PIC X(80) FROM WS_HDEP.
                   10  LINE 12 COL 2 PIC X(80) FROM WS_HARR.
                   10  LINE 13 COL 2 PIC X(80) FROM WS_NAVION.
                   10  LINE 13 COL 22 PIC 9(3) FROM WS_QUERY.
                   10  LINE 14 COL 2 PIC X(80) FROM WS_CIVPILOTE.
                   10  LINE 16 COL 2 PIC X(80) FROM WS_WARNING.
               05  VALFOOTER BACKGROUND-COLOR 0 FOREGROUND-COLOR 2.
                   10  LINE 19 COL 1 PIC X(80) FROM WS_LINE.
                   10  LINE 20 COL 2 PIC X(50) FROM WS_MSG.
                   10  LINE 21 COL 2 PIC X(50) FROM WS_INVITE.
                   10  LINE 22 COL 2 PIC X USING WS_VALID.
