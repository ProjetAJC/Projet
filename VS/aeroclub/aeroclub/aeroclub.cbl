       ...
       DATA DIVISION.
           ...
           77  WS_LINE     PIC X(80)   VALUE "_____________________".
           77  WS_MTITLE   PIC X(80)   VALUE "Veuillez choisir parm".
           77  WS_MENUF0   PIC X(80)   VALUE "    0 - Liste des avi".                                 
           77  WS_MENUF1   PIC X(80)   VALUE "    1 - Dépôt d'un pl".          
           77  WS_MENUF2   PIC X(80)   VALUE "    2 - Enregistreme".           
           77  WS_MENUF3   PIC X(80)   VALUE "    3 - Mise-à-jour  ".      
           77  WS_MENUF4   PIC X(80)   VALUE "    4 - Mise-à-jour de".
           77  WS_MENUF5   PIC X(80)   VALUE "    5 - Récapitulatif ".
           77  WS_MENUF6   PIC X(80)   VALUE "    6 - Récapitulatif ".
           77  WS_MENUF7   PIC X(80)   VALUE "    7 - Facturation de".
           77  WS_MQUIT    PIC X(80)   VALUE "    Q - Quitter l'ap".
